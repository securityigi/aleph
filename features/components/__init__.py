...
from features.base import SampleBase
from features.constants import SAMPLE_STATUS_PROCESSING, SAMPLE_STATUS_PROCESSED
from features.utils import get_path
...
class SampleManager(Process):
    ...
    def load_plugins(self):
        ...
        plugin_base = pluginbase.PluginBase(package='features.plugins', searchpath=[get_path('plugins')])
